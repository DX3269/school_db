...
export default function HomePage() {
  return (
    <main style={{ fontFamily: 'Arial, sans-serif', maxWidth: '800px', margin: '4rem auto', padding: '2rem', textAlign: 'center' }}>
      ...
      <header>
        <h1 style={{ fontSize: '2.5rem', color: '#0f0e0eff' }}>
      ...
      <section style={{ marginTop: '3rem', textAlign: 'left', borderTop: '1px solid #eee', paddingTop: '2rem' }}>
        <h2 style={{ fontSize: '1.8rem', color: '#030202ff', textAlign: 'center', marginBottom: '1.5rem' }}>
          How to Use This App
        </h2>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div>
            ...
            <InstructionText>
              After you have added one or more schools, go to the "Show All Schools" page by clicking the show school button or typing /show-schools in the URL. This page will fetch the data from the database and display every school in a responsive grid format, similar to an e-commerce website.
            </InstructionText>
          </div>
        </div>
      </section>
